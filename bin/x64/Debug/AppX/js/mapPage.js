...
(function () {
    ...
    var latitudeStartPoint;
    var longitudeStartPoint;
    ...
    WinJS.UI.Pages.define(mapPageURI, {
        ...
        ready: function (element, options) {
            ...
            if (options && options.location) {
                ...
                latitudeStartPoint = options.location.latitude;
                longitudeStartPoint = options.location.longitude;
                window.console.log("options location ", latitudeStartPoint + " " + longitudeStartPoint);
    ...
    function requestLocationCallback(position) {        
        ...
        latitudeStartPoint = position.coords.latitude;
        longitudeStartPoint = position.coords.longitude;
    ...
    function drivingDirecionsHandler() {
        ...
        //var uriToLaunch = 'http://www.bing.com/maps/default.aspx?rtp=~adr.One' + apotheke.street + ",  " + apotheke.zipcode + " " + apotheke.city + "~pos." + latitudeStartPoint + "_" + longitudeStartPoint;

        // http://maps.google.com/maps?saddr=new+york&daddr=baltimore
        var uriToLaunch = 'http://maps.google.com/maps?saddr=+' + latitudeStartPoint + ", " + longitudeStartPoint + "&daddr=" + apotheke.latitude + ", " + apotheke.longitude;

        //http://www.bing.com/maps/default.aspx?rtp=pos.50_2~pos.48_5~pos.45_10~pos.52_14&sty=a
        // http://www.bing.com/maps/default.aspx?rtp=adr.Seattle,WA~adr.One%20Microsoft%20Way,Redmond,WA

        window.console.log("drivingDirecionsHandler: ", uriToLaunch);
